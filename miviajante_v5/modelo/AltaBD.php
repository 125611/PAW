...
public function insert_Cliente(Cliente $cliente){
        ...
        $sql = "INSERT INTO `Cliente`"
                . "(`ID`, `nombre_cliente`, `apellido_cliente`, `password`, `correo_electronico`, `direccion`, `telefono`, `estado_cliente`)"
                . " VALUES ('','$nombre','$apellido',$password,'$correo','$direccion',$telefono,'0')";
