...
<section id="menu" class="bodySection"> 
    <nav>
        ...
        <li >
            ...
            <img src="{$path_base}/vista/SRC/icon_pedidos.png" alt="icono de pedidos">
            <p>En Esta seccion podremos administrar nuestros pedidos, crear nuevos pedidos, modificar o visualizar los ya existentes.</p> 
        </li>
        <li>
            <h2>Productos</h2>
            <img src="{$path_base}/vista/SRC/icon_productos.png" alt="icono de productos">
        ...
        <li>
            <h2>Otros</h2>
            <img src="{$path_base}/vista/SRC/icon_pedidos.png" alt="icono de otro">
